...
/* End  Media Query For Desktop */</style>
    ...
    <div class="header container">
      <div class="nav-bar">
        ...
        <div class="nav-list">
          ...
          <ul>
            <li><a href="#hero" data-after="Home">{{__('message.page_message')}}</a></li>
            <li><a href="#services" data-after="Interests">{{__('message.page_message2')}}</a></li>
            <li><a href="#projects" data-after="Projects">{{__('message.page_message3')}}</a></li>
            <li><a href="#about" data-after="About">{{__('message.page_message4')}}</a></li>
            <li><a href="#contact" data-after="Contact">{{__('message.page_message5')}}</a></li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <section id="hero">
    <div class="hero container">
      <div>
        <h1>{{__('message.page_message6')}} <span></span></h1>
        <h1>{{__('message.page_message7')}} <span></span></h1>
        <h1>{{__('message.page_message8')}}<span></span></h1>
        <a href="#projects" type="button" class="cta">{{__('message.page_message9')}}</a>
      </div>
    </div>
  </section>
  <!-- End Hero Section  -->
    ...
    <div class="services container">
      ...
      <div class="service-bottom">
        <div class="service-item">
          <div class="icon"><img src="https://lh3.googleusercontent.com/proxy/dMjMkhf_ycto4MKGBKsDNseWeicSJHjwumFCD9HCednDAKz1fv6xicQr9EQS2kx07vA6PkhW2y6i6umtAQHVNzC_fWsHvcd3NNiY-VUn"/></div>
          <h2>Sport</h2>
